...
export const PRODUCTS_CATALOG: Product[] = [
  ...
  // GARMENTS — SWEATERS
  {
    id: 'garment-sweater-men-wooly',
    name: "Men's Classic Wooly Crewneck Sweater",
    category: 'garments',
    categoryLabel: 'Finished Sweaters',
    countOrDenier: '7GG Fine Knit (2/18 Wooly Yarn)',
    description: "Wholesale premium men's crewneck sweater manufactured from imported 2/18 high-bulk Wooly yarn. Warm, featherlight, soft hand feel for bulk distribution across India.",
    recommendedUses: ['Men Winterwear', 'Corporate Apparel', 'Wholesale Garment Supply', 'Retail Outlets'],
    features: ['7GG Flat Knit', 'High Bulk Warmth', 'Pilling Resistant', 'Direct Ludhiana Dispatch'],
    sampleAvailable: true,
    origin: 'Ved Garment Collection (Ludhiana)',
    popularFor: 'Men Winter Sweater Collections',
    badge: 'Garment Collection',
    gauge: '7GG',
    yarnUsed: '2/18 Wooly Yarn',
    availableSizes: ['M', 'L', 'XL', 'XXL'],
    garmentStyle: 'Men Sweater'
  },
  {
    id: 'garment-sweater-ladies-vislon',
    name: 'Ladies Cashmere-Feel Vislon Cardigan Sweater',
    category: 'garments',
    categoryLabel: 'Finished Sweaters',
    countOrDenier: '12GG Fine Gauge (2/48 Vislon Yarn)',
    description: 'Elegant ladies buttoned cardigan sweater crafted from fine 2/48 Vislon yarn. Silky drape, vivid color fastness, and cashmere-soft touch.',
    recommendedUses: ['Ladies Winterwear', 'Boutique Sweater Collections', 'Wholesale Apparel'],
    features: ['12GG Fine Gauge', 'Silky Sheen', 'Ribbed Cuffs & Hem', 'Bulk Bale Packing'],
    sampleAvailable: true,
    origin: 'Ved Garment Collection (Ludhiana)',
    popularFor: 'Ladies Boutique Cardigans',
    badge: 'Garment Collection',
    gauge: '12GG',
    yarnUsed: '2/48 Vislon Yarn',
    availableSizes: ['S', 'M', 'L', 'XL'],
    garmentStyle: 'Ladies Cardigan'
  },
  {
    id: 'garment-sweater-kids-cable',
    name: 'Kids Heavy Cable Knit Winter Sweater',
    category: 'garments',
    categoryLabel: 'Finished Sweaters',
    countOrDenier: '5GG Heavy Gauge (Daffodil Acrylic)',
    description: 'Chunky cable-knit kids sweater knitted using high-bulk Daffodil acrylic yarn for maximum thermal insulation and durable daily wear.',
    recommendedUses: ['Kids Winterwear', 'School Uniforms', 'Retail Chain Supply'],
    features: ['5GG Cable Structure', 'Non-Itchy Acrylic', 'Vibrant Fast Colors', 'Machine Washable'],
    sampleAvailable: true,
    origin: 'Ved Garment Collection (Ludhiana)',
    popularFor: 'Kids Winter Pullovers & Uniforms',
    badge: 'Garment Collection',
    gauge: '5GG',
    yarnUsed: 'Daffodil 100% Acrylic',
    availableSizes: ['24', '28', '32', '36'],
